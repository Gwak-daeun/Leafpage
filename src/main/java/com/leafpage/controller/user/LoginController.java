...
public class LoginController implements Controller {
    ...
    private String handleLoginResult(int result, HttpSession session, String userId, boolean userEmailChecked, int userNo, HttpServletResponse response) {
        switch (result) {
            case -3:
    ...
    private void handleAdminLogin(HttpSession session, String userId, int userNo, HttpServletResponse response) {
    ...
    private void handleUserLogin(HttpSession session, String userId, boolean userEmailChecked, int userNo, HttpServletResponse response) {
    ...
    private void handleInactiveUserLogin(HttpSession session, String userId, boolean userEmailChecked, int userNo, HttpServletResponse response) {
        int userInactive = new UserDAO().setUserState(userId, "휴면회원");
        if(userInactive == 1) {
