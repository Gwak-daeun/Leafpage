...
public class FindPwController implements Controller {
    static final String PASSWORD_CHANGE_ACCESS_BUTTON = "<a id='change_pw_btn' data-bs-toggle='modal' data-bs-target='#newPasswordModal' class='btn btn-success mx-1 mt-2'>비밀번호 변경</a>";
