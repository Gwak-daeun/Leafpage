...
<form class="uploadform" action="/bookupload.do" method="post" enctype="multipart/form-data">
    <div class="modal-left-div">
        <img src="/image/iconmonstr-book-26-240.png"  id="image">
        <div class="filebox">
            <label for="image-upload">이미지 등록</label>
