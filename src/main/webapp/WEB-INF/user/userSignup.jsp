...
<header>
    <nav class="navbar index-nav">
        <div class="container-fluid">
            ...
            <span></span>
            <span>
                <button type="button" class=" btn2 btn-sm" onclick="href='signupView.do'">회원가입</button>
                <button type="button" class=" btn1 btn-sm" onclick="location.href='loginView.do'">로그인</button>
            </span>
        </div>
    </nav>
</header>
...
<div class="main container-fluid">
    ...
    <form method="post" action="signup.do" >
        ...
        <div class="input-group">
            ...
            <button type="submit" class="btn1 btn-outline-secondary" type="button" id="button-addon2">중복확인</button>
        </div>
        ...
        <div class="input-group">
            <input type="email" name="userEmail" class="form-control" placeholder="mega@megazone.com">
        </div>

        <label class="signup form-label">전화번호</label>
        <div class="input-group">
            <input type="number" name="userTel" class="form-control" placeholder="01012341234">
        </div>

        <label class="signup form-label">비밀번호 찾기 질문</label>
        <div class="input-group">
            <select class="form-select" name="userSecurityQuestion" aria-label="select">
        ...
        <div class="input-group mb-3">
            <input type="text" name="userSecurityAnswer" class="form-control" placeholder="비밀번호 찾기 답">
        </div>
        ...
        <div class="form-floating">
            <button type="submit" class="btn3 btn btn-success" onclick="location.href='signupView.do'">회원가입</button>
        </div>
